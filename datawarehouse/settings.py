...
SECRET_KEY = 'django-insecure-=58olh2$9*kffo)&558%nz=3_$zt)u9nq(rjgns#+6i%5n=amd'
...
AWS_DATA_BUCKET = config('AWS_DATA_BUCKET', default='your-data-bucket-name')
...
REDSHIFT_PORT = config('REDSHIFT_PORT', default='5439')
